...
function loadUser (email, datos) {  
    var logged = document.getElementById("nameUser");
    logged.innerHTML= datos.username;

    //Evita errores referidos al html.
...
window.addEventListener('load', (event) => {  
    ...
    if(window.location.pathname.includes("/index.html")) {
        ...
        getData();
        //Condicional para controlar los botones de la página de home.
        if(window.location.pathname.includes("/home.html")){
            var btnLogin = document.getElementById("btn_log");
            var btnLogout = document.getElementById("btn_logOut");
            var btnRegister = document.getElementById("btn_reg");
        ...
        if(window.location.pathname.includes("/index_admin.html")){
            if(sessionStorage.getItem("email") === null) {
                location.replace("./home.html");
            }
            if(JSON.parse(sessionStorage.getItem("profile")).admin === false) {
                location.replace("./index_user.html");
            }
        }
        if(window.location.pathname.includes("/index_user.html")){
            if(sessionStorage.getItem("email") === null) {
                location.replace("./home.html");
            }
            if(JSON.parse(sessionStorage.getItem("profile")).admin === true) {
                location.replace("./index_admin.html");
            }
        }
    } 
